...
FROM registry.access.redhat.com/ubi9/ubi@sha256:9e6e193bfc3596a84d2a32f42d6b1552398ec9735b9a4e893a0fc3c6fbccb381 AS opensearch_builder
...
########################################
# ubi9/ubi:latest (pinned 2026-03-24)
FROM registry.access.redhat.com/ubi9/ubi@sha256:9e6e193bfc3596a84d2a32f42d6b1552398ec9735b9a4e893a0fc3c6fbccb381
...
RUN echo "#!/bin/bash" > /usr/share/opensearch/profile.sh && \
    ...
    chmod 755 /usr/share/opensearch/profile.sh
